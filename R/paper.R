...
paper_duration <- function(portf_qty, portf_prz, hist_prz, last_dtt, trx_dtt,
	...
	if (!is.POSIXct(last_dtt) || !is.POSIXct(trx_dtt)) {
...
paper_compute <- function(portf_qty, portf_prz, hist_prz, last_dtt, trx_dtt,
	...
	if (method == "count") {
		...
		pgl_count <- pmap(list(portf_qty, portf_prz, hist_prz), paper_count, allow_short)
		...
		pgl_total <- pmap(list(portf_qty, portf_prz, hist_prz), paper_total, allow_short)
		...
		pgl_value <- pmap(list(portf_qty, portf_prz, hist_prz), paper_value, allow_short)
		...
		pgl_duration <- pmap(list(portf_qty, portf_prz, hist_prz), paper_duration,
