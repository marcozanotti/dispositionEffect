import pandas as pd
import numpy as np
from src.dispositioneffect.utils.difftime import financial_difftime
...
class Paper:
    ...
    def __init__(self, df_input, allow_short, method):
    ...
    def _paper_duration(self, portfolio_quantity, portfolio_price, market_price, transaction_datetime=None,
        ...
        """
        Computation of paper gains and paper losses as simple financial duration.
    ...
    def _paper_count(self, portfolio_quantity, portfolio_price, market_price):
        """
        Computation of paper gains and paper losses as simple counts.
    ...
    def _paper_total(self, portfolio_quantity, portfolio_price, market_price):
        """
        Computation of paper gains and paper losses as simple quantity of assets.
    ...
    def _paper_value(self, portfolio_quantity, portfolio_price, market_price):
        """
        Computation of paper gains and paper losses as simple expected return of assets.
